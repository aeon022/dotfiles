...
alias aider-local='OLLAMA_API_BASE=http://localhost:11434 aider --model ollama/mistral'
alias aider-qwen='OLLAMA_API_BASE=http://localhost:11434 aider --model ollama/qwen2.5-coder:7b'
